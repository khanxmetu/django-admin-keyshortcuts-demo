...
wget --no-host-directories -P ./django_admin_demo_snapshot/django-admin-keyshortcuts-demo/static/admin/js/vendor/hotkey --load-cookies $COOKIES $HOST/django-admin-keyshortcuts-demo/static/admin/js/vendor/hotkey/hotkey.js
